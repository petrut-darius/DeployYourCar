...
return [
     ...
     */
    'queue_conversions_by_default' => env('QUEUE_CONVERSIONS_BY_DEFAULT', true),//if set on true add a worker cause it is a queue, is set on false then no queue so no worker
