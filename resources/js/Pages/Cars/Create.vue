...
<template>
    <AppLayout>
        <form @submit.prevent="submit" class="w-2/6 text-center mx-auto">
            <div>
            ...
            <div>
                the story must be done with tiptap, looking forward to this
            </div>

            <div>
                <InputLabel for="tags" value="Tags" />
                
                <select v-model="form.tags" id="tags" multiple class="mt-1 block w-full max-h-40 overflow-y-auto">
            ...
            <div>
                ...
                <select v-model="form.types" id="types" multiple class="mt-1 block w-full max-h-40 overflow-y-auto">
